export const AppData = {
  mainBannerData: {
    companyName: 'Kriyawantika Solutions',
    tagLine: 'We provide Enterprise level software development and support services'
  },
  domainData: [{
      imageUrl: 'assets/images/webapp.png',
    ...
    {
      imageUrl: 'assets/images/mobileapp.png',
      ...
      domainDetails: {
        ...
        mobile application development has its roots in more traditional software development. One critical difference, however, 
        is that mobile apps are often written specifically to take advantage of the unique features of a particular mobile device.`,
        details: [
            { 
                heading: 'How we do it',
    ...
    {
      imageUrl: 'assets/images/desktopapp.png',
      ...
      domainDetails: {
        ...
        it has to be installed on other device also. Like word, excel, pdf reader etc applications. Our developers keep in mind all the aspects and devices when developing applications.`,
        details: [
            { 
                heading: 'How we do it',
    ...
    {
      imageUrl: 'assets/images/cloudapp.png',
    ...
    },
    {
      ...
      domainDetails: {
        ...
        of information systems with constantly growing and changing business requirements by their own efforts, not involving resources of hardware 
        and software manufacturers (vendors) and integrators (companies with experience in the field of information system introduction).`,
        details: [
            { 
                heading: 'How we do it',
    ...
    },
    {
      ...
      domainDetails: {
        ...
        receive information, or both. This ability to send and/or receive information makes things “smart."`,
        details: [
            { 
                heading: 'How we do it',
